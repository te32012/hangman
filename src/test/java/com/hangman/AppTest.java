...
public class AppTest {
    ...
    public void Test1() {
        ...
        categoris.put(Category.FIRST, List.of( new Pair<String>("программа", "то что хранит информацию.")));
    ...
    public void Test6() {
        ...
        // При проверка отображения подсказки
        @Test
        public void Test7() {
            HashMap<Category, List<Pair<String>>> categoris = new HashMap<>();
            categoris.put(Category.FIRST, List.of( new Pair<String>("программа", "то что хранит информацию.")));
            ...
            game.nextGame();
            System.out.println(bytes.toString());
            Assert.assertEquals( "Подсказка:\n" + //
                                "то что хранит информацию.\n" + //
                                "Текущее слово:\n" + //
                                "*********\n" + //
                                "количество возможных ошибок:\n" + //
                                "5\n" + //
